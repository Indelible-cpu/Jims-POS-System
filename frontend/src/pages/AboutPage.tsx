        ...
        {sections.map((section) => (
          ...
          >
            <div className="flex items-center gap-3">
              <div className="p-2 bg-surface-card border border-surface-border rounded-none">
                {section.icon}
              </div>
              <h3 className="text-lg font-black tracking-tight">{section.title}</h3>
            </div>

            <div className="bg-surface-card border border-surface-border rounded-none overflow-hidden">
              {section.items ? (
        ...
        <footer className="text-center pt-10 space-y-8">
          <div className="space-y-2">
            ...
            <div className="flex justify-center gap-4 mt-4">
              {/* WhatsApp Support */}
              <a href="https://wa.me/265993732694" title="WhatsApp Support" aria-label="WhatsApp Support" className="w-16 h-16 bg-surface-card border border-surface-border rounded-none flex items-center justify-center hover:border-emerald-500/30 transition-all group shadow-sm">
              ...
              {/* Facebook Support */}
              <a href="https://www.facebook.com/JEFInvestment" target="_blank" rel="noreferrer noopener" title="Facebook Support" aria-label="Facebook Support" className="w-16 h-16 bg-surface-card border border-surface-border rounded-none flex items-center justify-center hover:border-blue-500/30 transition-all group shadow-sm">
              ...
              {/* Direct Call */}
              <a href="tel:+265885892269" title="Direct Call" aria-label="Direct Call" className="w-16 h-16 bg-surface-card border border-surface-border rounded-none flex items-center justify-center hover:border-primary-500/30 transition-all group shadow-sm">
              ...
              {/* Email Support */}
              <a href="mailto:msikaposmw@gmail.com" title="Email Support" aria-label="Email Support" className="w-16 h-16 bg-surface-card border border-surface-border rounded-none flex items-center justify-center hover:border-orange-500/30 transition-all group shadow-sm">
