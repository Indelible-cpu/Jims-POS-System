        ...
        <footer className="text-center pt-10 space-y-8">
          <div className="space-y-2">
            ...
            <div className="flex justify-center gap-4 mt-4">
              {/* WhatsApp Support */}
              <a href="https://wa.me/265993732694" title="WhatsApp Support" aria-label="WhatsApp Support" className="w-16 h-16 bg-surface-card border border-surface-border rounded-2xl flex items-center justify-center hover:border-emerald-500/30 transition-all group shadow-sm">
              ...
              {/* Facebook Support */}
              <a href="fb://facewebmodal/f?href=https://www.facebook.com/JEFInvestment" target="_blank" rel="noreferrer" title="Facebook Support" aria-label="Facebook Support" className="w-16 h-16 bg-surface-card border border-surface-border rounded-2xl flex items-center justify-center hover:border-blue-500/30 transition-all group shadow-sm">
              ...
              {/* Direct Call */}
              <a href="tel:+265885892269" title="Direct Call" aria-label="Direct Call" className="w-16 h-16 bg-surface-card border border-surface-border rounded-2xl flex items-center justify-center hover:border-primary-500/30 transition-all group shadow-sm">
              ...
              {/* Email Support */}
              <a href="mailto:msikaposmw@gmail.com" title="Email Support" aria-label="Email Support" className="w-16 h-16 bg-surface-card border border-surface-border rounded-2xl flex items-center justify-center hover:border-orange-500/30 transition-all group shadow-sm">
