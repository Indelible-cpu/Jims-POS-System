  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-surface-bg text-surface-text">
      ...
      >
        ...
        <h1 className="text-2xl font-black uppercase tracking-tight mb-4">System Locked</h1>
        <p className="text-surface-text/40 text-xs font-bold uppercase tracking-widest leading-relaxed mb-8">
          Access to JIMS POS is currently restricted by the Super Administrator or due to non-working hours.
        </p>
        
        <div className="flex items-center justify-center gap-3 py-4 px-6 bg-surface-card border border-surface-border rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] text-surface-text/30">
